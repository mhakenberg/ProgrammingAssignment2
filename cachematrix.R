...
## matrix (if previously computed by cacheSolve) are stored, ready to access by cacheSolve function
...
## and if there is no inverse matrix stored (for input parameter x) then reads matrix stored in the list, 
